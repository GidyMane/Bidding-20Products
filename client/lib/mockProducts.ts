...
export const mockProducts: MockProduct[] = [
  {
    ...
    description: 'Excellent condition iPhone 14 with minimal signs of use. All functions work perfectly.',
    categoryId: 'smartphones',
    condition: 'LIKE_NEW',
    images: ['https://images.unsplash.com/photo-1592286927505-1dad139508b7?w=400&h=400&fit=crop'],
  ...
  },
  {
    ...
    description: 'Barely used MacBook Air M1 with original box and charger. Like new condition.',
    categoryId: 'laptops',
    condition: 'NEW',
  ...
  },
  {
    ...
    description: 'Good condition iPad with minor scratches on back. Fully functional.',
    categoryId: 'tablets',
    condition: 'GOOD',
    images: ['https://images.unsplash.com/photo-1544716278-ca5e3af4abd8?w=400&h=400&fit=crop'],
  ...
  },
  {
    ...
    description: 'Excellent condition Switch OLED with games and accessories included.',
    categoryId: 'gaming',
    condition: 'EXCELLENT',
    images: ['https://images.unsplash.com/photo-1535869788-e34ca9c7a7e0?w=400&h=400&fit=crop'],
  ...
  },
  {
    ...
    description: 'Like new Apple Watch with minimal wear. Perfect screen and battery.',
  ...
  },
  {
    ...
    description: 'Excellent condition noise-cancelling headphones. All features working perfectly.',
    categoryId: 'audio',
    condition: 'EXCELLENT',
